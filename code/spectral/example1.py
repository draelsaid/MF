...
#u0  = Ao/(np.cosh(Bo*xx))**2           # sech**2 pulse amplitude 
#u0x = diff(u0, period=2*np.pi*loik);   # speed is -c*u0x
#u0xx= diff(u0x, period=2*np.pi*loik);  # second derivative by space
